...
public final class ALSDriver {
   ...
   */
  @Inject
  public ALSDriver(final EvaluatorRequestor requestor, final DataLoadingService dataLoadingService) {
    LOG.log(Level.FINE, "Instantiated 'ALSCFDriver'");
  ...
  public final class StartHandler implements EventHandler<StartTime> {
    ...
    public void onNext(final StartTime startTime) {
      ...
      ALSDriver.this.requestor.submit(null);
    }
  }
  */
