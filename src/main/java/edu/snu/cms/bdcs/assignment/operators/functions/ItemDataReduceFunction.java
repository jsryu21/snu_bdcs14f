...
/**
 * Group all the data by the item id
 */
public class ItemDataReduceFunction implements Reduce.ReduceFunction<Map<Integer, Map<Integer, Long>>> {
  private static final Logger LOG = Logger.getLogger(ItemDataReduceFunction.class.getName());

  @Inject
  public ItemDataReduceFunction() {
  }
